...
# Back-compat alias for skins / env overrides that still reference the old name.
HERMES_AGENT_LOGO = LOTUS_AGENT_LOGO
...
def format_banner_version_label() -> str:
    ...
    base = f"{AGENT_DISPLAY_NAME} v{VERSION} ({RELEASE_DATE})"
...
def build_welcome_banner(console: "Console", model: str, cwd: str,
    ...
    if term_width >= 95:
        _logo = _bskin.banner_logo if _bskin and hasattr(_bskin, 'banner_logo') and _bskin.banner_logo else LOTUS_AGENT_LOGO
        console.print(_logo)
        console.print()
