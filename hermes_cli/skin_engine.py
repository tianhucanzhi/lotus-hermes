...
class SkinConfig:
    ...
    banner_logo: str = ""    # Rich-markup ASCII art logo (replaces LOTUS_AGENT_LOGO)
...
def _lotus_branding(**overrides: str) -> Dict[str, str]:
    from hermes_constants import AGENT_DISPLAY_NAME

    branding = {
        "agent_name": AGENT_DISPLAY_NAME,
        "welcome": f"Welcome to {AGENT_DISPLAY_NAME}! Type your message or /help for commands.",
        "goodbye": "Goodbye! ⚕",
        "response_label": f" ⚕ {AGENT_DISPLAY_NAME} ",
        "prompt_symbol": "❯",
...
_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        "name": "default",
        "description": "Classic Lotus — gold and kawaii",
        "colors": {
...
[dim #6B1717]⠀⠀⠀⠀⠀⠀⠀⠀war god online⠀⠀⠀⠀⠀⠀⠀⠀[/]""",
    ...
    "mono": {
        ...
        "spinner": {},
        "branding": _lotus_branding(help_header="[?] Available Commands"),
        "tool_prefix": "┊",
    },
    "slate": {
        "name": "slate",
    ...
    "warm-lightmode": {
        ...
        "spinner": {},
        "branding": _lotus_branding(prompt_symbol="\u276f"),
        "tool_prefix": "\u250a",
    },
    "poseidon": {
        "name": "poseidon",
