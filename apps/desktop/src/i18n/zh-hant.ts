...
export const zhHant = defineLocale({
  ...
  titlebar: {
    ...
    openRealApiTitle: 'Real-Api聚合全球 最頂級AI 模型-瀏覽器中打開',
    editionPersonal: '個人版',
  ...
  settings: {
    ...
    customProviders: {
      loading: '正在載入自訂端點…',
      intro: '將 OpenAI 相容 API 儲存到 config.yaml 的 custom_providers（vLLM、Ollama、私有 API 等）。',
      addButton: '新增端點',
      addTitle: '新建自訂端點',
      editTitle: '編輯自訂端點',
      empty: '還沒有自訂端點。新增後可讓 Lotus 連線你自己的 API。',
      nameLabel: '顯示名稱',
      namePlaceholder: '我的 API',
      baseUrlLabel: 'Base URL',
      baseUrlHint: 'OpenAI 相容根位址，通常以 /v1 結尾',
      baseUrlRequired: '請先填寫 Base URL。',
      apiKeyLabel: 'API 金鑰',
      apiKeyHint: '可選。編輯時留空表示保留現有金鑰。',
      apiKeyPlaceholder: 'sk-…（可選）',
      apiKeyKeepPlaceholder: '留空則保留目前金鑰',
      apiKeySet: '已設定 API 金鑰',
      modelLabel: '模型',
      modelHint: '傳給 API 的模型 id。可點「測試」從 /v1/models 自動發現。',
      modelPlaceholder: 'model-name',
      modelRequiredForMain: '設為主模型前請先填寫模型名稱。',
      noModelSet: '未設定預設模型',
      apiModeLabel: '協定模式',
      apiModeHint: '一般選「自動」即可，除非端點需要特定 API 格式。',
      apiModeAuto: '自動',
      ...
      probeButton: '測試',
      probeOk: '端點可達。',
      probeFound: count => `發現 ${count} 個模型。`,
      probeUnreachable: '無法連線該端點。',
      useAsMain: '設為主模型',
      saved: '自訂端點已儲存。',
      saveFailed: '無法儲存自訂端點。',
      saving: '儲存中…',
      requiredFields: '名稱和 Base URL 為必填項。',
      deleteConfirm: name => `刪除自訂端點「${name}」？`,
      appliedMain: name => `主模型已切換為 ${name}。`,
      applyFailed: '無法將該端點設為主模型。'
    },
    sessions: {
      loading: '正在載入已封存工作階段…',
  ...
  skills: {
    ...
    hub: {
      ...
      connectedHubs: '已連線來源：',
      connecting: '正在連線技能市場…',
      detailDescription: name => `安裝前預覽並掃描 ${name}。`,
      details: '詳情',
      dismiss: '關閉',
      emptyLanding: '在上方搜尋，瀏覽可安裝的技能。',
      featuredHint: '來自 Hermes 索引 — 搜尋可發現更多',
      featuredTitle: '精選技能',
      files: '檔案',
      install: '安裝',
      installCompleteMessage: '可在「技能」標籤中啟用，新工作階段生效。',
      installCompleteTitle: '技能已安裝',
      installFailed: '安裝失敗',
      installStarting: identifier => `正在安裝 ${identifier}…`,
      installed: '已安裝',
      loading: '正在載入技能市場…',
      loadingPreview: '正在載入 SKILL.md…',
      noFindings: '未發現安全問題。',
      noResults: '市場中未找到相符的技能。',
      openSkill: name => `開啟 ${name}`,
      policyBlock: '策略阻止安裝',
      previewEmpty: '（SKILL.md 為空）',
      previewFailed: '預覽失敗',
      previewLoadFailed: '無法載入技能內容。',
      readSkillMd: '閱讀 SKILL.md',
      rescan: '重新掃描',
      scanFailed: '安全掃描失敗',
      scanPrompt: '安裝前可執行安全掃描。',
      scanning: '正在取得並掃描…',
      search: '搜尋',
      searchFailed: '市場搜尋失敗',
      searchMeta: (count, ms) => `${count} 筆結果${ms != null ? ` · ${ms}ms` : ''}`,
      searchPlaceholder: '搜尋技能市場…',
      searching: '正在搜尋市場…',
      securityScan: '安全掃描',
      sourcesFallback: '結果與 hermes skills search 使用相同來源。',
      timedOut: sources => `${sources} 請求逾時`,
      trust: {
        trusted: '可信',
        builtin: '內建',
        community: '社群',
