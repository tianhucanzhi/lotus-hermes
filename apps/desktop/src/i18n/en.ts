...
export const en: Translations = {
  ...
  boot: {
    ready: 'Lotus Desktop is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading Lotus settings',
      loadingSessions: 'Loading recent sessions',
      startingDesktopConnection: 'Starting desktop connection',
      startingHermesDesktop: 'Starting Lotus Desktop…'
    },
    errors: {
      backgroundExited: 'Lotus background process exited.',
      backgroundExitedDuringStartup: 'Lotus background process exited during startup.',
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your Lotus backend is older than this desktop build and may not work correctly. Update to align them.',
    updateHermes: 'Update Lotus',
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting Lotus Desktop.',
  ...
  titlebar: {
    ...
    openRealApi: 'Real API',
    openRealApiTitle: 'Real-Api — top global AI models aggregated — open in browser',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to Lotus defaults?',
    ...
    nav: {
      ...
      providerCustom: 'Custom endpoints',
      gateway: 'Gateway',
      apiKeys: 'Tools & Keys',
      keysTools: 'Tools',
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let Lotus follow your system setting.',
    ...
    about: {
      ...
      automaticUpdatesDesc:
        'Lotus checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading Lotus configuration...',
    ...
    gateway: {
      ...
      intro:
        'Lotus Desktop starts its own local gateway by default. Use a remote gateway when you want this app to control an already-running Lotus backend on another machine or behind a trusted proxy. Pick a profile below to give it its own remote host.',
      ...
      localDesc: 'Start a private Lotus backend on localhost. This is the default and works offline.',
      remoteTitle: 'Remote gateway',
      remoteDesc:
        'Connect this desktop shell to a remote Lotus backend. Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      ...
      restartingMessage: 'Lotus Desktop will reconnect using the saved settings.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · Lotus ${version}` : ''}`,
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. Lotus runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
    ...
    customProviders: {
      ...
      intro:
        'OpenAI-compatible endpoints saved to config.yaml as custom_providers (vLLM, Ollama, private APIs, etc.).',
      addButton: 'Add endpoint',
      addTitle: 'New custom endpoint',
      editTitle: 'Edit custom endpoint',
      empty: 'No custom endpoints yet. Add one to point Lotus at your own API.',
      nameLabel: 'Display name',
      namePlaceholder: 'My API',
      baseUrlLabel: 'Base URL',
      baseUrlHint: 'OpenAI-compatible root, usually ending with /v1',
      baseUrlRequired: 'Enter a base URL first.',
      apiKeyLabel: 'API key',
      apiKeyHint: 'Optional. Leave blank to keep the existing key when editing.',
      apiKeyPlaceholder: 'sk-… (optional)',
      apiKeyKeepPlaceholder: 'Leave blank to keep current key',
      apiKeySet: 'API key set',
      modelLabel: 'Model',
      modelHint: 'Model id sent to the API. Use Test to discover models from /v1/models.',
      modelPlaceholder: 'model-name',
      modelRequiredForMain: 'Set a model name before using this endpoint as main.',
      noModelSet: 'No default model',
      apiModeLabel: 'Wire protocol',
      apiModeHint: 'Leave on Auto unless your endpoint needs a specific API shape.',
      apiModeAuto: 'Auto',
      apiModeChat: 'Chat completions',
      apiModeCodex: 'Codex responses',
      apiModeAnthropic: 'Anthropic messages',
      probeButton: 'Test',
      probeOk: 'Endpoint is reachable.',
      probeFound: count => `Found ${count} model(s).`,
      probeUnreachable: 'Could not reach that endpoint.',
      useAsMain: 'Use as main',
      saved: 'Custom providers saved.',
      saveFailed: 'Could not save custom providers.',
      saving: 'Saving…',
      requiredFields: 'Name and base URL are required.',
      deleteConfirm: name => `Remove custom endpoint "${name}"?`,
      appliedMain: name => `Main model switched to ${name}.`,
      applyFailed: 'Could not apply this endpoint as the main model.'
    },
    sessions: {
  ...
  skills: {
    ...
    hub: {
      ...
      detailDescription: name => `Preview and scan ${name} before installing.`,
      details: 'Details',
      dismiss: 'Dismiss',
      emptyLanding: 'Search above to browse installable skills from connected sources.',
      featuredHint: 'from the Hermes index — search for thousands more',
      featuredTitle: 'Featured skills',
      files: 'Files',
      install: 'Install',
      installCompleteMessage: 'Refresh the Skills tab to enable it for new sessions.',
      installCompleteTitle: 'Skill installed',
      installFailed: 'Install failed',
      installStarting: identifier => `Installing ${identifier}…`,
      installed: 'Installed',
      loading: 'Loading marketplace…',
      loadingPreview: 'Loading SKILL.md…',
      noFindings: 'No findings reported.',
      noResults: 'No matching skills found in the marketplace.',
      openSkill: name => `Open ${name}`,
      policyBlock: 'Blocked by policy',
      previewEmpty: '(SKILL.md is empty)',
      previewFailed: 'Preview failed',
      previewLoadFailed: 'Could not load the skill source.',
      readSkillMd: 'Read SKILL.md',
      rescan: 'Re-scan',
      scanFailed: 'Security scan failed',
      scanPrompt: 'Run a security scan before installing.',
      scanning: 'Fetching and scanning…',
      search: 'Search',
      searchFailed: 'Marketplace search failed',
      searchMeta: (count, ms) => `${count} result${count === 1 ? '' : 's'}${ms != null ? ` · ${ms}ms` : ''}`,
      searchPlaceholder: 'Search the skill marketplace…',
      searching: 'Searching marketplace…',
      securityScan: 'Security scan',
      sourcesFallback: 'Results come from the same sources as hermes skills search.',
      ...
      updateStarting: 'Updating installed skills…',
      verdict: value => value
    }
  },
  ...
  commandCenter: {
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure Lotus desktop' },
    ...
    hermesActiveSessions: (version, count) => `Lotus ${version} · Active sessions ${count}`,
  ...
  profiles: {
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent Lotus environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. Lotus will run it and deliver results to the destination you pick.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting Lotus...',
    placeholderReconnecting: 'Reconnecting to Lotus…',
    ...
    attachUrlDesc: 'Lotus will fetch the page and include it as context for this turn.',
  ...
  updates: {
    ...
    unsupportedMessage: 'This version of Lotus can’t update itself from inside the app.',
    connectionRetry: 'Check your connection and try again.',
    latestBody: 'You’re running the latest version.',
    allSetTitle: 'You’re all set',
    availableTitle: 'New update available',
    availableBody: 'A new version of Lotus is ready to install.',
    updateNow: 'Update now',
    maybeLater: 'Maybe later',
    moreChanges: count => `+ ${count} more change${count === 1 ? '' : 's'} included.`,
    manualTitle: 'Update from your terminal',
    manualBody: 'You installed Lotus from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'Lotus will pick up the new version next time you launch it.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody: 'The Lotus updater will take over in its own window and reopen Lotus when it’s done.',
    applyingClose: 'Lotus will close to apply the update.',
  ...
  install: {
    ...
    oneTimeTitle: 'Lotus needs a one-time install',
    ...
    settingUpTitle: 'Setting up Lotus Agent',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another Lotus CLI or desktop instance is running. Stop any running Lotus instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
      'This is a one-time setup. The Lotus installer is downloading dependencies and configuring your machine. Subsequent launches will skip this step.',
  ...
  onboarding: {
    ...
    preparingInstall: 'Lotus is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting Lotus…',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description: 'Point Lotus at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — Lotus connects automatically',
      loopback: 'Opens your browser to sign in — Lotus connects automatically',
    ...
    authorizeThere: 'Authorize Lotus there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize Lotus there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  shell: {
    ...
    statusbar: {
      ...
      desktopVersion: version => `Lotus Desktop v${version}`,
      ...
      gatewayTitle: 'Lotus inference gateway status',
      agents: 'Agents',
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. Lotus will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'Lotus is restarting...',
      askRestart: 'Ask Lotus to restart the server',
      lookingRestart: taskId => `Lotus is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'Lotus is working in the background. Watch the preview console for progress.',
      ...
      finishedRestarting: message => `Lotus finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'Lotus could not restart the server.',
      stillWorking:
        'Lotus is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'Lotus is loading a response',
      thinking: 'Thinking',
    ...
    approval: {
      gatewayDisconnected: 'Lotus gateway is not connected',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.hermes/config.yaml). Lotus won’t ask again for commands like this — in this session or any future one.`,
  ...
  prompts: {
    ...
    sudoDesc: 'Lotus needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'Lotus needs a credential to continue.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart Lotus Desktop to use Save Image.',
    restartToSaveImages: 'Restart Lotus Desktop to save images',
