...
export const ja = defineLocale({
  ...
  titlebar: {
    ...
    openRealApiTitle: 'Real-Api — 世界トップクラスのAIモデルを集約 — ブラウザで開く',
    editionPersonal: '個人版',
    editionEnterprise: '企業版'
  },
  ...
  settings: {
    ...
    customProviders: {
      loading: 'カスタムプロバイダーを読み込み中…',
      intro: 'OpenAI 互換エンドポイントを config.yaml の custom_providers に保存します。',
      addButton: 'エンドポイントを追加',
      addTitle: '新しいカスタムエンドポイント',
      editTitle: 'カスタムエンドポイントを編集',
      empty: 'カスタムエンドポイントはまだありません。',
      nameLabel: '表示名',
      namePlaceholder: 'My API',
      baseUrlLabel: 'Base URL',
      baseUrlHint: '通常 /v1 で終わる OpenAI 互換のルート URL',
      baseUrlRequired: 'Base URL を入力してください。',
      apiKeyLabel: 'API キー',
      apiKeyHint: '任意。編集時に空欄のままにすると既存のキーを保持します。',
      apiKeyPlaceholder: 'sk-…（任意）',
      apiKeyKeepPlaceholder: '空欄のまま現在のキーを保持',
      apiKeySet: 'API キー設定済み',
      modelLabel: 'モデル',
      modelHint: 'API に送るモデル ID。テストで /v1/models から検出できます。',
      modelPlaceholder: 'model-name',
      modelRequiredForMain: 'メインにする前にモデル名を設定してください。',
      noModelSet: 'デフォルトモデルなし',
      apiModeLabel: 'ワイヤプロトコル',
      apiModeHint: '通常は自動のままで問題ありません。',
      apiModeAuto: '自動',
      apiModeChat: 'Chat completions',
      apiModeCodex: 'Codex responses',
      apiModeAnthropic: 'Anthropic messages',
      probeButton: 'テスト',
      probeOk: 'エンドポイントに到達できました。',
      probeFound: count => `${count} 件のモデルを検出しました。`,
      probeUnreachable: 'エンドポイントに到達できませんでした。',
      useAsMain: 'メインに設定',
      saved: 'カスタムプロバイダーを保存しました。',
      saveFailed: 'カスタムプロバイダーを保存できませんでした。',
      saving: '保存中…',
      requiredFields: '名前と Base URL は必須です。',
      deleteConfirm: name => `カスタムエンドポイント「${name}」を削除しますか？`,
      appliedMain: name => `メインモデルを ${name} に切り替えました。`,
      applyFailed: 'メインモデルとして適用できませんでした。'
    },
    sessions: {
  ...
  skills: {
    ...
    hub: {
      ...
      actionRunning: '実行中',
      actionStarting: '開始中…',
      connectedHubs: '接続済みハブ:',
      connecting: 'スキルハブに接続中…',
      detailDescription: name => `インストール前に ${name} をプレビュー・スキャンします。`,
      details: '詳細',
      dismiss: '閉じる',
      emptyLanding: '上で検索して、インストール可能なスキルを閲覧してください。',
      featuredHint: 'Hermes インデックスから — 検索でさらに多数を発見',
      featuredTitle: 'おすすめスキル',
      files: 'ファイル',
      install: 'インストール',
      installCompleteMessage: '「スキル」タブで有効化し、新しいセッションで使用できます。',
      installCompleteTitle: 'スキルをインストールしました',
      installFailed: 'インストールに失敗しました',
      installStarting: identifier => `${identifier} をインストール中…`,
      installed: 'インストール済み',
      loading: 'マーケットを読み込み中…',
      loadingPreview: 'SKILL.md を読み込み中…',
      noFindings: '問題は見つかりませんでした。',
      noResults: 'マーケットに一致するスキルがありません。',
      openSkill: name => `${name} を開く`,
      policyBlock: 'ポリシーによりブロック',
      previewEmpty: '（SKILL.md は空です）',
      previewFailed: 'プレビューに失敗しました',
      previewLoadFailed: 'スキルソースを読み込めませんでした。',
      readSkillMd: 'SKILL.md を読む',
      rescan: '再スキャン',
      scanFailed: 'セキュリティスキャンに失敗しました',
      scanPrompt: 'インストール前にセキュリティスキャンを実行できます。',
      scanning: '取得してスキャン中…',
      search: '検索',
      searchFailed: 'マーケット検索に失敗しました',
      searchMeta: (count, ms) => `${count} 件${ms != null ? ` · ${ms}ms` : ''}`,
      searchPlaceholder: 'スキルマーケットを検索…',
      searching: 'マーケットを検索中…',
      securityScan: 'セキュリティスキャン',
      sourcesFallback: '結果は hermes skills search と同じソースから取得されます。',
      timedOut: sources => `${sources} がタイムアウト`,
      trust: {
        trusted: 'trusted',
        builtin: 'builtin',
        community: 'community',
      ...
      updateStarting: 'インストール済みスキルを更新中…',
      verdict: value => value
    }
  },
