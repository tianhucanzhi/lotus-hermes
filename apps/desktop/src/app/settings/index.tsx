...
import { Archive, Globe, Info, KeyRound, Link, Settings2, Sparkles, Wrench, Zap } from '@/lib/icons'
        ...
        <OverlaySidebar>
          ...
          {activeView === 'providers' && (
            <div className="ml-3.5 flex flex-col gap-0.5 pl-1.5">
              ...
              />
              <OverlayNavItem
                active={providerView === 'custom'}
                icon={Link}
                label={t.settings.nav.providerCustom}
                nested
                onClick={() => openProviderView('custom')}
              />
            </div>
          )}
          <OverlayNavItem
