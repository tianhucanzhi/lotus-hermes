...
export const PROVIDER_VIEWS = ['accounts', 'keys', 'custom'] as const
...
export function ProvidersSettings({ onConfigSaved, onMainModelChanged, onViewChange, view }: ProvidersSettingsProps) {
  ...
  if (view === 'custom') {
    return <CustomProvidersSettings onConfigSaved={onConfigSaved} onMainModelChanged={onMainModelChanged} />
  }
